...
class Raft:
  ...
  async def restore(self, meta: types.SnapshotMeta, reader: types.AsyncReader) -> None :...

  async def restore_timeout(self, meta: types.SnapshotMeta, reader: types.AsyncReader, timeout: timedelta) -> None :...
